...
async function main(data) {
  ...
  try {
    ...
    const map = [
      ...
      ['F15','play_clock_preset_start',{seconds:25},'F15','Load play clock 25 and start (Quick 25)'],
      ['F16','play_clock_preset_start',{seconds:40},'F16','Load play clock 40 and start (Quick 40)'],
      ...
      ['F19','play_clock_clear',{},'F19','Clear play clock'],
