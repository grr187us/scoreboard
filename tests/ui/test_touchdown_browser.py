"""Touchdown artwork exercised through real Python programs and the player."""
...
class TouchdownBrowserTests(unittest.TestCase):
    def test_tiger_scene_timeline_readability_and_recovery(self):
        ...
        program = build_program(play_id=1, event='touchdown', pack=builtin_pack('touchdown'),
        ...
        self.assertNotIn('score', program['texts'])
        result = run_browser('touchdown.cjs', {
