...
| Game-clock display precision | Whole seconds only, always rounded up, shown as `M:SS` even below a minute (for example, internal 12:25.1 displays `12:26`; internal 29.9 displays `0:30`) | Owner decision | Confirmed; supersedes the September 4, 2026 tenths-below-a-minute rule (September 7, 2026: tenths read as basketball, not football) |
| Play-clock display precision | Whole seconds only, always rounded up; no tenths at any point in the countdown | Owner decision | Confirmed; supersedes the September 4, 2026 tenths-below-five-seconds rule (September 7, 2026) |
...
| F-039 | The game clock MUST display remaining whole seconds rounded up, shown as `M:SS` at every value including below a minute (whole seconds only; no tenths, September 7, 2026). Thus 60.0, 59.99, and 59.9 all display `1:00`, 59.0 displays `0:59`, and 12:25.1 displays `12:26`. | Boundary formatter tests using exact nanosecond values. |
...
| F-047 | The play clock MUST display remaining whole seconds rounded up at every value; no tenths at any point in the countdown (September 7, 2026). Thus 5.0, 4.99, and 4.9 all display `5`, and 4.0 displays `4`. | Boundary formatter tests using exact nanosecond values. |
